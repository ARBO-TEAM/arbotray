...
* **Network Tools**: utilitas diagnostik jaringan seperti *ping*, *traceroute*, pengecekan DNS, dan analisis koneksi.
* **Speed Test**: uji coba performa koneksi (*download*, *upload*, dan *ping*) sesuai permintaan (*on-demand*).
* **Test History**: melihat rekam jejak dan riwayat hasil pengujian kecepatan sebelumnya.
* **Usage Stats**: rincian pembagian penggunaan kuota internet harian dan bulanan.
* **Network Info**: informasi teknis lengkap seperti alamat IP, DNS, *gateway*, dan detail koneksi.
* **Network Interface**: statistik mendalam untuk setiap antarmuka (*interface*) jaringan yang terpasang.
